...
def serializedATN():
    return [
        4,1,27,75,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        ...
        3,1,3,1,3,1,3,1,3,1,3,1,3,3,3,49,8,3,1,4,1,4,1,4,1,4,1,4,1,4,1,4,
        1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,3,4,69,8,4,1,5,1,5,1,
        6,1,6,1,6,0,0,7,0,2,4,6,8,10,12,0,2,1,0,13,16,1,0,17,27,79,0,14,
        1,0,0,0,2,17,1,0,0,0,4,25,1,0,0,0,6,48,1,0,0,0,8,68,1,0,0,0,10,70,
        1,0,0,0,12,72,1,0,0,0,14,15,3,2,1,0,15,16,5,0,0,1,16,1,1,0,0,0,17,
        22,3,4,2,0,18,19,5,4,0,0,19,21,3,4,2,0,20,18,1,0,0,0,21,24,1,0,0,
        0,22,20,1,0,0,0,22,23,1,0,0,0,23,3,1,0,0,0,24,22,1,0,0,0,25,30,3,
        6,3,0,26,27,5,3,0,0,27,29,3,6,3,0,28,26,1,0,0,0,29,32,1,0,0,0,30,
        28,1,0,0,0,30,31,1,0,0,0,31,5,1,0,0,0,32,30,1,0,0,0,33,49,3,8,4,
        0,34,49,3,12,6,0,35,36,5,7,0,0,36,49,3,8,4,0,37,38,5,7,0,0,38,49,
        3,12,6,0,39,40,5,5,0,0,40,41,3,2,1,0,41,42,5,6,0,0,42,49,1,0,0,0,
        43,44,5,7,0,0,44,45,5,5,0,0,45,46,3,2,1,0,46,47,5,6,0,0,47,49,1,
        0,0,0,48,33,1,0,0,0,48,34,1,0,0,0,48,35,1,0,0,0,48,37,1,0,0,0,48,
        39,1,0,0,0,48,43,1,0,0,0,49,7,1,0,0,0,50,51,5,2,0,0,51,69,3,10,5,
        0,52,53,5,8,0,0,53,54,5,2,0,0,54,69,3,10,5,0,55,56,5,9,0,0,56,57,
        5,2,0,0,57,69,3,10,5,0,58,59,5,10,0,0,59,60,5,2,0,0,60,69,3,10,5,
        0,61,62,5,11,0,0,62,63,5,2,0,0,63,69,3,10,5,0,64,65,5,2,0,0,65,66,
        5,12,0,0,66,67,5,2,0,0,67,69,3,10,5,0,68,50,1,0,0,0,68,52,1,0,0,
        0,68,55,1,0,0,0,68,58,1,0,0,0,68,61,1,0,0,0,68,64,1,0,0,0,69,9,1,
        0,0,0,70,71,7,0,0,0,71,11,1,0,0,0,72,73,7,1,0,0,73,13,1,0,0,0,4,
        22,30,48,68
    ]
...
class QueryParser ( Parser ):
    ...
    class NotParenExprContext(ExprContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitNotParenExpr" ):
                return visitor.visitNotParenExpr(self)
            else:
                return visitor.visitChildren(self)
    ...
    def expr(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = QueryParser.NotParenExprContext(self, localctx)
